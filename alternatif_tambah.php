    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kode_alternatif" value="<?=set_value('_alternatif', kode_oto('kode_alternatif', 'tb_alternatif', 'A', 2))?>"/>
            </div>
            <div class="form-group">
                <label>Nama Alternatif <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama_alternatif" value="<?=$_POST['nama_alternatif']?>" id="nama"/>                
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="luas_lahan" value="<?=$_POST['luas_lahan']?>"/>
            </div>
			<div class="form-group">
                <label>Harga Lahan</label>
                <input class="form-control" type="text" name="harga_lahan" value="<?=$_POST['harga_lahan']?>"/>
            </div>
            <div class="form-group">
                <label>Pilih Warna Polygon</label>
                <input class="form-control" type="color" name="warna" value="<?=set_value('warna')?>"/>
            </div>
            <div class="form-group hidden">
                <label>Area</label>
                <textarea class="form-control" name="area"><?=set_value('area')?></textarea>
            </div>
            <div class="form-group">
